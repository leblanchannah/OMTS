        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <form action='selected_showing.php' method='post'>
                <?php
                    $dbh = new PDO('mysql:host=localhost;dbname=db_omts', "root", "");
                    $rows = $dbh->query("SELECT * from showing where showing.movie_id = $selected_movie");
                    ...
                    if ($num_showings) {
                        ...
                        echo "There are no showings for this movie at the moment. Please check again later.";
                    }
                ?>
            </form>
          </div>
